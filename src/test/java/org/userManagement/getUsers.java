...
public class getUsers  extends BaseTest {
    ...
    //validate single field from the list of map
    @Test
    ...
    public void testCreateUserWithFormParam() {
        Response response = given()
              ...
              //  .formParam("name", "John Doej")
                .contentType("application/json")
                .body("{\"name\": \"John Doej\", \"job\": \"Developers\"}")
             //   .formParam("job", "Developers")
                .when()
        ...
        response.then().body("name", equalTo("John Doej"));
        response.then().body("job", equalTo("Developers"));
    }
    ...
    public void validateWithTestDataFromJson() throws IOException, ParseException {
        ...
        System.out.println("username from json is: " + username + " and password from json is:" + password);
        Response resp = given()
                .auth()
